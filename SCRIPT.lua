-- I FIXED SMALL BUGS FOR E.X (Hand freeze by respawning)
...
TextLabel.Text = "REMADE BY XAVIER?#9231"
...
TextLabel_5.Text = "04/20/2023 fixed animations ig"
...
TextLabel_6.Text = "idk what to write here"
